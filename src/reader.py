                ...
                for header in headers:
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            print(
                                f"Record {file},{record_number},{header}: {data} = sent successfully:\n {response.text} \n"
                            )
                            ...
                            print(
                                f"Error sending record {file},{record_number},{header}: {data}: {response.status_code}"
                            )
